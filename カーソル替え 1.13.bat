...
rem V‚µ‚¢ƒAƒbƒvƒf[ƒg—LŒøGUI‚ğÀ‘•‚·‚éB
rem ƒo[ƒWƒ‡ƒ“î•ñ‚Ì•”•ª‚ğƒI[ƒo[ƒŒƒC‹Zp‚ğ—˜—p‚µ‚Ä‰ü—Ç‚·‚é
rem ‚»‚Ì‘¼ ‚ğƒƒCƒ“ƒƒjƒ…[‚ÉÀ‘•‚·‚éB‚»‚ÌÛ‚É‚Í‚“x‚ÈifƒJƒ‰[‹Zp‚ğÌ—p‚·‚é
rem ‚Å‚«‚ê‚Î‚æ‚è—Ç‚¢“d‘ì‚ğŠ®¬‚³‚¹‚ÄÀ‘•‚·‚é
...
rem ã‚É”º‚¢A‚æ‚èƒJƒeƒSƒiƒ‰ƒCƒY‚³‚ê‚½İ’èGUI‚ğÀ‘•‚·‚éB
rem ˆø”w’èAƒZƒbƒgƒAƒbƒv‚³‚ê‚Ä‚¢‚È‚¢Ewindows version check‚Éˆø‚Á‚©‚©‚Á‚Ä‚¢‚éê‡‚ÉƒGƒ‰[‚ğo‚· (”¼•ªI‚í‚è)
...
>nul 2>&1 find "bootanimation=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
if "!errorlevel!"=="0" (
>nul 2>&1 find "s5_simpleboot=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
if "!errorlevel!"=="0" (
...
>nul 2>&1 find "bootanimation=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
if "!errorlevel!"=="0" (
>nul 2>&1 find "s5_rawboot=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
if "!errorlevel!"=="0" (
    if not "%linuxboot%"=="true" (
...
for /l %%i in (1,1,%n%) do (
  ...
  if not "!current!"=="" (
    ...
    if "!current!"=="recovery" (call :batbootcheckwinver dynamic&echo recovery mode‚ğ—LŒø‚É‚µ‚Ü‚µ‚½B&set argmentserror=false&goto Cursor_Changer_REmenu)
    if "!current!"=="help" (call :batbootcheckwinver dynamic&title ˆø”‚Ìƒwƒ‹ƒv&call :batstarthelp&set argmentserror=false)
...
set "clr1=[38;2;%clresc%m                      ƒJ[ƒ\ƒ‹‘Ö‚¦ %batver% ‚Ö‚æ‚¤‚±‚» [0m"
echo.
echo %clr1%
...
set /a clr+=10
set clresc=%clr%;%clr%;%clr%
set "clr2=[38;2;%clresc%m                         [‰½‚©ƒL[‚ğ‰Ÿ‚µ‚Än‚ß‚é] [0m"
echo.
echo %clr1%
echo.& echo.
echo %clr2%
...
echo wmode=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦İ’è.txt
    ...
    echo s5_linuxboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
    echo s5_simpleboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
    echo s5_rawboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
...
echo nodogcheckfor1234567890qwertyuiop > ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo CheckUpdate=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo wmode=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo admin=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo rebootokey=true >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo typosWarning=true >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo bootanimation=true >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo s5_linuxboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo s5_simpleboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
echo s5_rawboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
exit /b
...
:setting5_s1load
find "s5_linuxboot=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
...
:setting5_s2load
find "s5_simpleboot=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
...
:setting5_s3load
find "s5_rawboot=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
...
find "s5_linuxboot=false" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
if %ErrorLevel%==0 (set setting5_s1onoff=–³Œø) else if %ErrorLevel%==1 set setting5_s1onoff= null&set /a allsettingerror=allsettingerror+1
if {%bootbatnow%}=={yes} (set batloadprgs=5&call :MOBAS_Loader)
...
find "s5_simpleboot=false" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
if %ErrorLevel%==0 (set setting5_s2onoff=–³Œø) else if %ErrorLevel%==1 set setting5_s2onoff= null&set /a allsettingerror=allsettingerror+1
if {%bootbatnow%}=={yes} (set batloadprgs=5&call :MOBAS_Loader)
...
find "s5_rawboot=false" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
if %ErrorLevel%==0 (set setting5_s3onoff=–³Œø) else if %ErrorLevel%==1 set setting5_s3onoff= null&set /a allsettingerror=allsettingerror+1
if {%bootbatnow%}=={yes} (set batloadprgs=5&call :MOBAS_Loader)
...
if not {%allsettingerror%} equ {0} (
    ...
    echo ƒtƒ@ƒCƒ‹ƒpƒX‚Í%batchmainpath%‚Å‚·B
...
if "%setting5onoff%"=="–³Œø" if "%setting5_stg_whereyou%"=="stg2" (goto :settingcategory2intsetting5_stg0) else if "%setting5onoff%"=="–³Œø" if "%setting5_stg_whereyou%"=="stg0" (goto :settingcategory2intsetting5_stg2)
...
:setting5_1ygo3test
find "s5_linuxboot=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
if %ErrorLevel%==1 echo s5_linuxboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
if %ErrorLevel%==0 goto setting5_1ygo2

:setting5_1ygo2
powershell "(gc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt) -replace 's5_linuxboot=true','s5_linuxboot=false' | sc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt"
set linuxboot=false
goto setting5_1yokey

:setting5_1ygo1
powershell "(gc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt) -replace 's5_linuxboot=false','s5_linuxboot=true' | sc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt"
set linuxboot=true
goto setting5_1yokey
...
:setting5_2ygo3test
find "s5_simpleboot=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
if %ErrorLevel%==1 echo s5_simpleboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
if %ErrorLevel%==0 goto setting5_2ygo2

:setting5_2ygo2
powershell "(gc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt) -replace 's5_simpleboot=true','s5_simpleboot=false' | sc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt"
set simpleboot=false
goto setting5_2yokey

:setting5_2ygo1
powershell "(gc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt) -replace 's5_simpleboot=false','s5_simpleboot=true' | sc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt"
set simpleboot=true
goto setting5_2yokey
...
:setting5_3ygo3test
find "s5_rawboot=true" ƒJ[ƒ\ƒ‹‘Ö‚¦.txt > nul
if %ErrorLevel%==1 echo s5_rawboot=false >> ƒJ[ƒ\ƒ‹‘Ö‚¦.txt
if %ErrorLevel%==0 goto setting5_3ygo2

:setting5_3ygo2
powershell "(gc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt) -replace 's5_rawboot=true','s5_rawboot=false' | sc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt"
set rawboot=false
goto setting5_3yokey

:setting5_3ygo1
powershell "(gc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt) -replace 's5_rawboot=false','s5_rawboot=true' | sc ƒJ[ƒ\ƒ‹‘Ö‚¦.txt"
set rawboot=true
goto setting5_3yokey
