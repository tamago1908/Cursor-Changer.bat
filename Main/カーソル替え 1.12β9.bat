...
rem ƒR[ƒh‚ÌÅ‰‚É“ü‚ê‚ê‚éˆ—‚Ì”‚ÍŒÀ‚ç‚ê‚Ä‚¢‚Ü‚·(“ü‚ê‚·‚¬‚é‚Æ‹N“®‚ª’x‚­‚È‚é‰Â”\«) (’x‚­‚È‚Á‚½ (è’x‚ê) )
rem ƒrƒ‹ƒhƒiƒ“ƒo[‚Æƒo[ƒWƒ‡ƒ“‚Ì‹L“ü‚Í•K‚¸‚µ‚Ä‚­‚¾‚³‚¢I‚ ‚ÆƒA[ƒJƒCƒu‚É“ü‚ê‚é‚Ì‚ğ–Y‚ê‚¸‚ÉI
rem ‚»‚µ‚ÄÅ‹ßA‚±‚Ìƒoƒbƒ`ˆ—‚É‰pŒê‚ğ‘½‚­ŠÜ‚ß‚é‚æ‚¤‚É‚µ‚Ä‚¢‚éB‚È‚º‚È‚çA«—ˆ“I‚É‚±‚Ìƒoƒbƒ`ˆ—‚ğ–|–ó‚·‚é‚±‚Æ‚É‚È‚Á‚½A“ú–{Œê‚ª‘½‚¢‚Æ–Ê“|‚¾‚©‚çBS
title ƒJ[ƒ\ƒ‹•Ï‚¦
rem VER v1.12ƒÀ9
set batver=1.12ƒÀ9
...
rem ˆê”ÔŠJ”­‚ÉŠÔ‚ª‚©‚©‚Á‚½‚Ì‚Íƒo[ƒWƒ‡ƒ“1.10‚Å‚ ‚éB
